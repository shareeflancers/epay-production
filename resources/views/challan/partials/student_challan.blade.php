{{-- ================================================================ --}}
{{-- EXISTING STUDENT / PAID-RECEIPT LAYOUT                          --}}
{{-- ================================================================ --}}
<div class="container">
    @if($challan->status === 'P')
        {{-- PAID RECEIPT FORMAT --}}
    ...
    @else
        ...
        <div class="challan-copy voucher-copy">
            ...
            <table class="details-table" style="font-size: 9px; margin: 5px 0;">
                ...
                @if(!empty($snapshot['arrears_calculation']['details']))
                    <tr><th>Current Fee</th><td>Rs. {{ number_format($challan->amount_base, 0) }}/-</td></tr>
                    @foreach($snapshot['arrears_calculation']['details'] as $detail)
                        ...
                        @endif
                    @endforeach
                @elseif($challan->amount_arrears > 0)
                    <tr><th>Current Fee</th><td>Rs. {{ number_format($challan->amount_base, 0) }}/-</td></tr>
                    <tr style="background:#fff8e1;"><th style="color:#c0392b;">Arrears</th><td style="color:#c0392b;">Rs. {{ number_format($challan->amount_arrears, 0) }}/-</td></tr>
                @endif
